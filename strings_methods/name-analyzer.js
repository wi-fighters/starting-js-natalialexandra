...
The first letter of your name is ${trimName[0]}, the last is ${
  trimName[trimName.length - 1]
}.
...
The first letter of your name is ${trimName2[0]}, the last is ${
  trimName2[trimName2.length - 1]
}.
If I wanted to be funny, I would call you ${trimName}chmoo.`);
